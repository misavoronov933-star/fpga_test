...
// Command     : write_verilog -force -mode synth_stub -rename_top microblaze_core_inst_0_proc_sys_reset_0_0 -prefix
//               microblaze_core_inst_0_proc_sys_reset_0_0_ design_ddr_proc_sys_reset_0_1_stub.v
...
/* synthesis syn_force_seq_prim="slowest_sync_clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 clock CLK" *) (* x_interface_mode = "slave clock" *) (* x_interface_parameter = "XIL_INTERFACENAME clock, ASSOCIATED_RESET mb_reset:bus_struct_reset:interconnect_aresetn:peripheral_aresetn:peripheral_reset, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0, CLK_DOMAIN design_ddr_mig_7series_0_0_ui_clk, INSERT_VIP 0" *) input slowest_sync_clk /* synthesis syn_isclock = 1 */;
