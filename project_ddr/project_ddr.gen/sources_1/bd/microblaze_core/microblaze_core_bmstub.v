...
module microblaze_core (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.INTERCONNECT_ARESETN, POLARITY ACTIVE_LOW, INSERT_VIP 0" *)
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.PERIPHERAL_ARESETN, POLARITY ACTIVE_LOW, INSERT_VIP 0" *)
  output [0:0]peripheral_aresetn;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.PERIPHERAL_RESET RST" *)
  (* X_INTERFACE_MODE = "master RST.PERIPHERAL_RESET" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.PERIPHERAL_RESET, POLARITY ACTIVE_HIGH, INSERT_VIP 0" *)
  output [0:0]peripheral_reset;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SLOWEST_SYNC_CLK CLK" *)
  (* X_INTERFACE_MODE = "slave CLK.SLOWEST_SYNC_CLK" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SLOWEST_SYNC_CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_jesd_clk_wiz_0_0_clk_100MHz, ASSOCIATED_BUSIF M_AXI_DP:S_AXI, ASSOCIATED_RESET interconnect_aresetn:peripheral_aresetn:peripheral_reset, INSERT_VIP 0" *)
