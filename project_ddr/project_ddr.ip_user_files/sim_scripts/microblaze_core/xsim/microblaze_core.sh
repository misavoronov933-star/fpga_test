...
#
# Script generated by Vivado on Tue Jun 23 00:34:10 +0300 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : microblaze_core.sh
...
#
# Usage        : microblaze_core.sh
#                microblaze_core.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                microblaze_core.sh [-reset_run]
#                microblaze_core.sh [-reset_log]
#                microblaze_core.sh [-help]
#
...
export RDI_DATADIR="C:/Xilinx/Vivado/2024.2/Vivado/2024.2/data"
...
# script info
echo -e "microblaze_core.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./microblaze_core.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L lmb_bram_if_cntlr_v4_0_25 -L lmb_v10_v3_0_14 -L axi_lite_ipif_v3_0_4 -L mdm_v3_2_27 -L microblaze_v11_0_14 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L xlconstant_v1_1_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot microblaze_core xil_defaultlib.microblaze_core xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim microblaze_core -key {Behavioral:sim_1:Functional:microblaze_core} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fe39.protoinst" -protoinst "protoinst_files/design_ddr.protoinst" -protoinst "protoinst_files/microblaze_core.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb microblaze_core.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./microblaze_core.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: microblaze_core.sh [-help]\n\
Usage: microblaze_core.sh [-step]\n\
Usage: microblaze_core.sh [-lib_map_path]\n\
Usage: microblaze_core.sh [-reset_run]\n\
Usage: microblaze_core.sh [-reset_log]\n\
Usage: microblaze_core.sh [-keep_index]\n\
Usage: microblaze_core.sh [-noclean_files]\n\n\
