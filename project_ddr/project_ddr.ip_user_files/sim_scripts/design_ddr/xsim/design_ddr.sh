...
#
# Script generated by Vivado on Tue Jun 23 00:18:28 +0300 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_ddr.sh
...
#
# Usage        : design_ddr.sh
#                design_ddr.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_ddr.sh [-reset_run]
#                design_ddr.sh [-reset_log]
#                design_ddr.sh [-help]
#
...
# script info
echo -e "design_ddr.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_ddr.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L util_vector_logic_v2_0_4 -L xlconstant_v1_1_9 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_ddr xil_defaultlib.design_ddr xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_ddr -key {Behavioral:sim_1:Functional:design_ddr} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fe39.protoinst" -protoinst "protoinst_files/design_ddr.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_ddr.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_ddr.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_ddr.sh [-help]\n\
Usage: design_ddr.sh [-step]\n\
Usage: design_ddr.sh [-lib_map_path]\n\
Usage: design_ddr.sh [-reset_run]\n\
Usage: design_ddr.sh [-reset_log]\n\
Usage: design_ddr.sh [-keep_index]\n\
Usage: design_ddr.sh [-noclean_files]\n\n\
