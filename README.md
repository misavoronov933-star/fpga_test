...
![Проверка AXI Boundary](img/axi_boundary_check.png) Рис.1. Проверка AXI 4K Boundary
![Проверка Циклического буфера с разбиением одной транзакции записи данных](img/ram_256Mb_check.png) Рис.2. Проверка Циклического буфера с разбиением одной транзакции записи данных
![Проверка Циклического буфера с двумя транзакциями записи данных](img/ram_236Mb_check_2.png) Рис. 3. Проверка Циклического буфера с двумя транзакциями записи данных
