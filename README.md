...
<center>Рис.1. Проверка AXI 4K Boundary</center>

![Проверка Циклического буфера с разбиением одной транзакции записи данных](img/ram_256Mb_check.png)

<center>Рис.2. Проверка Циклического буфера с разбиением одной транзакции записи данных</center>

![Проверка Циклического буфера с двумя транзакциями записи данных](img/ram_236Mb_check_2.png)

<center>Рис. 3. Проверка Циклического буфера с двумя транзакциями записи данных</center>
